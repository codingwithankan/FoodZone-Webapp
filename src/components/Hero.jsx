  ...
  return ( 
    <div className='max-w-[1640px] mx-auto p-4 bg-black '>
        <div className='max-h-[500px] relative'>
            {/* Overlay */}
            <div className='absolute w-full h-full text-yellow-400 max-h-[500px] bg-black/40 flex flex-col justify-center'>
            ...
            <img className='w-full max-h-[500px] object-cover ' src="https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="/" />
        </div>
    </div>
  )
}
